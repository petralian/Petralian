...
Boutique firms operate with focused expertise in specialized areas. During my time at Merkle, we implemented the [Circle loyalty](https://www.dfs.com/en/hong-kong/dfs-circle-overview-hong-kong) program for [DFS globally](https://www.dfs.com/). Our team largely comprised of boutique specialists from [500friends](https://www.ycombinator.com/companies/500friends) (a boutique loyalty agency we acquired), who provided specialized expertise in customer loyalty mechanics. When I was a project director at [Isobar](http://isobar.com), I was effectively a part of [Bluecom](https://www.linkedin.com/company/bluecom-the-e-commerce-experts/about/), an acquired boutique agency who's sole focus was providing ecommerce services.
...
My experience collaborating with consultancies like [Accenture](http://Accenture.com) while implementing the Global Salesforce Commerce Cloud core for Shiseido APAC, and competing against Deloitte when positioning Merkle for campaign operations for [Estée Lauder](https://www.esteelauder.com.hk/en-hk/) across 7 APAC markets, illustrated their distinctive approach.
