...
image_prompt: >-
  Cinematic 16:9 conference room before standup: single clipboard on table with
  blank structured form, chairs angled inward, early morning window light, no
  readable text, no faces, no logos.
image_prompt_variant_1: >-
  Surreal 16:9 subway map room: one central departure board feeds five platform
  tunnels labeled with abstract icons only, teal transit glow, no readable text.
image_prompt_variant_2: >-
  Bold isometric 16:9 poster: Standup ritual column merges into Bridge file
  stack then Agent read arrow, risograph amber and slate, no logos.
featured_image_alt: >-
