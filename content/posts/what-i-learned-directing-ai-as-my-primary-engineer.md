...
- Agentic AI
- Program Delivery
excerpt: I built two software products with AI as the primary engineer. Not as an
  assistant to a team - as the team. Here's the leadership account of what I actually
  learned.
focus_keyword: directing AI as primary engineer
seo_title: What I Learned Directing AI as My Primary Engineer
meta_description: I built two software products solo with AI as the primary engineer.
  Here's a first-person leadership account of context management, the efficiency curve,
  and what enterprise programs should expect.
featured_image: null
featured_image_alt: A single person reviewing and directing AI-generated code builds
