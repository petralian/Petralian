...
featured_image_alt: "Hero illustration for AI Shopping Revolution: Will Shopify''s ChatGPT Integration Redefine Retail"
---
...
-   **Customer Relationship Ownership**: When implementing the Circle loyalty program for DFS globally, we emphasized the importance of first-party customer relationships. _**Who "owns" the customer relationship in this new model?**_
...
The possibility of [Claude](https://www.anthropic.com/claude) or other AI assistants integrating with [Amazon checkout](https://developer.amazon.com/docs/amazon-pay-checkout/get-set-up-for-integration.html) also creates an interesting competitive dynamic. When developing omnichannel commerce strategies for brands, where possible, I always considered marketplace ecosystem effects. In this case, if marketplaces were to create similar AI integrations, it could further strengthen their already formidable position.
